...
const char *const THREAD_NAMES[NUM_THREADS] = { "vent_control", "log_handler", "sensor_monitoring", "supervisor_input",
	"lcd_screen", "temperature_sensor", "led", "potentiometer", "state_management" };
